...
class PetEpicsInterface(EpicsAdapter):
    ...
    pvs = {
        'energy': PV('energy', read_only=True, type='int'),
        'tired': PV('tired', read_only=True, type='int'),
        'bored': PV('bored', read_only=True, type='int'),
        'clean': PV('clean', read_only=True, type='int'),
        'state': PV('state', read_only=True, type='string'),
        'age': PV('age', read_only=True, type='int'),
